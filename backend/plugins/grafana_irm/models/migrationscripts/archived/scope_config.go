...
// ConnectionId and Name come from `common.ScopeConfig` on the live model;
// the archived `archived.ScopeConfig` base only carries Model + Entities, so
// declare them explicitly (same pattern as incidentio's archived ScopeConfig).
